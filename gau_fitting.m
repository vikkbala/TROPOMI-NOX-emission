...
% [gau_model_bin,along_wind, no2_vc_summed] =  gau_model([emission_gau(1), 0 ], lifetime_gau, lat_sou, lon_sou, era5_ws_ano, a_r);
% [gau_model_bin, along_wind, no2_vc_summed] =  gau_model([0, emission_gau(2)], lifetime_gau, lat_sou, lon_sou, era5_ws_ano, a_r);
